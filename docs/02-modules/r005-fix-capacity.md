...
| 日期 | 轮次 | 改了什么 | 回链 |
| --- | --- | --- | --- |
| 2026-09-20 | r009.5 | 补正（无行为变更）：r005 容量口径（按本库在册成员）· 房间事件系统消息 · 取票去 LiveKit 查询 的台账/审查回填、轮次号与死链纠错、索引回填；实现页所述行为未改 | `docs/rounds/r009.5-debt-backfill/`；`docs/00-requirements/r009.5-debt-backfill.md` |
