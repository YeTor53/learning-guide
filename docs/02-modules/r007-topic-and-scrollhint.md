...
| 日期 | 轮次 | 改了什么 | 回链 |
| --- | --- | --- | --- |
| 2026-09-20 | r009.5 | 补正（无行为变更）：r007 工具栏换回 hero 下 + 浮动下箭头 · 主题控件风格化与主题扩容 14 项 · 侧边栏默认收起 的台账/审查回填、轮次号与死链纠错、索引回填；实现页所述行为未改 | `docs/rounds/r009.5-debt-backfill/`；`docs/00-requirements/r009.5-debt-backfill.md` |
