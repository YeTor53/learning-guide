...
| cp-r009.5-5 | 门禁与取证收官（pytest/smoke/tsc/build + E0 实测 + E11 截图 + 两页教学页 + review 定稿 + 模块页变更记录 + 索引最终回填） | **完成 2026-09-20** | `17e97e8` | E9~E12 |
| cp-r009.5-5b | **收官后复验补正**：抓到 r008 `review.md` E11 行漏改的「移至 r009」1 处 + `docs/README.md` 概览段与 §1 目录地图的页数（61 → 128 及各类目实数） | **完成 2026-09-20** | 见 cp-5b 提交 | E5/E8 |
