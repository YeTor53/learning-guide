...
| `docs/99-archive/r003-ahead-m4-ended-rooms-archive.md`（新增） | backlog 构思（目标 M4） | 结束后房间的管理与「归档」：语义 / 权限矩阵 / §3.1「离开即截止」截断 / 形态对比 / 页面 IA / 函数级草案（含 `visible_until_for`）/ 软删迁移 / A1~A6 已拍板 + A7~A9 待拍 | roadmap §9 该行回填 + `redirect-02.md` | **landed**（本轮不做实现，判 C；2026-09-19 按批复更新为 10.3k 字） |
...
| 8 | 2026-09-19 | 「2 1（但是数据截至至他离开）1 2 1 1」 | 批准（W2：答 A1~A6 六条分支点，含一条口径补充） | r003-02 §8 |
| 9 | 2026-09-19 | 「1 1 3（但是设计时，给出软删的数据将不被保护，会在必要时被清理）」 | 批准（W2：答 A7~A9 三条追加，含一条口径补充） | r003-02 §8 |
