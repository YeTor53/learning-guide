...
| cp-r004-2 | r003 收官回填（**已完成部分**）+ 文档工程体检与三页导览 + `smoke.py` 补 r002 四步（待做） | 进行中 2026-09-19 | 见本轮 docs 提交 | 索引表 r003 转 closed（已）、需求单 r003 转 closed（已）、roadmap §7/§9 回填（已）；smoke 待做 |
