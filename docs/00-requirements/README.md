...
| r010 | （实现轮）语音转文字并入讨论流（**换轨 Agents 侧识别**，ADR-0023） | `r010-transcription.md` | **实现完成，待合并**（cp-1~cp-5 + spike-01 + CR-01/02，2026-09-20） | `docs/rounds/r010-transcription/`（含 `cr-01/02.md`、`spike-01-path-a.md`、review 定稿） | 合并后由人打 `round-r010-done`（cp tag `cp-r010-*`） |
