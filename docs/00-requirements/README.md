...
| r007 | （补轮）首屏向下引导 + 主题控件风格化 + 主题扩容（14 项）+ 侧边栏默认收起 | `r007-topic-and-scrollhint.md` | draft（实现中，2026-09-19） | `docs/rounds/r007-topic-and-scrollhint/` | 合并后由人打 `round-r007-done` |
