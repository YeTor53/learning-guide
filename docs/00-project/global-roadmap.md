...
| **焦点系统重做**（均分铺满布局 + 举手经管理确认得焦点 + 举手框闪烁 + 协管需他人批准 + 房主一键取得 + 退出焦点按钮 + 麦克风悬浮键声波） | 你 2026-09-19 指定「下轮先做焦点系统」 | **进行中（r009）**：澄清单与 Q1~Q11 已备（`docs/rounds/r009-focus-system/redirect-01.md`）；会动到 r004 的布局与优先级口径，需新 ADR | r009（未开分支） |
| 语音转文字（默认开启 + 并入文字对话 + 含管理信息）+ STT 获取方案设计 | 你 2026-09-19 追加 | **排队 r010**：澄清单与 Q1~Q6 已备（`docs/rounds/r010-transcription/redirect-01.md`），STT 方案四选待拍板 | r011（未开） |
