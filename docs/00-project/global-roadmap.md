...
| 语音转文字（默认开启 + 并入文字对话 + 含管理信息）+ STT 获取方案设计 | 你 2026-09-19 追加 | **下一轮 r009**：澄清单与 Q1~Q6 已备（`docs/rounds/r009-transcription/redirect-01.md`），STT 方案四选待拍板 | r009（未开） |
| 好友 + 在线用户 + 定向邀请弹窗 + 邀请留言 | 你 2026-09-19 追加 | **下一轮 r010**：澄清单与 Q1~Q8 已批（`docs/rounds/r010-friends-and-invites/redirect-01.md`）；Q5=SSE、Q7 好友邀请无时限 | r010（未开） |
