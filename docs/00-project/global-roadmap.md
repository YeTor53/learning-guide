...
10. **r010 实现完成、待合并（2026-09-20，`req/r010-transcription` @ `ace6720`）**：语音转文字并入讨论流（**换轨**：识别走房间侧 Agents worker + LiveKit Inference，ADR-0023；落库仍走我方 HTTP）。cp-1~cp-5 + 补正 cp-5b/5c 全落；**零配额真机 E2E** 通过（3 人房：worker 入场 13.4s、三端「转写：开启」、气泡 32/33/35、库 35 行）；门禁 156 passed / smoke 46/46 / tsc · build 绿。未闭合项见 `docs/rounds/r010-transcription/review.md` §5。
11. **r009.5 已收官（2026-09-20）**：r008/r009 欠账补正（台账 · tag · 审查回填 · 纠错 · 取证 · 教学页），**只修欠账不加功能**；分支 `req/r009.5-debt-backfill` @ `4c6401d`（7 提交）已并入 r010 分支的祖先链。合并顺序：**r005 → r006 → r007 → r008 → r009 → r010**。
...
## 9. 遗留台账（r001 收官 2026-09-17；**r009.5 补正 2026-09-20 增补三行**）
