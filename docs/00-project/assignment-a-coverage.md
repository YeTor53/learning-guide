...
| 房间录制 / 旁路录音转写后生成纪要 | **部分**（2026-09-20） | **转写已实现**（r010：房间侧识别 → 文字并入讨论流 → 进纪要素材；ADR-0023）；**录制 / 旁路录音本身仍未做** |
...
| 房间录制 / 旁路录音转写后生成纪要 | **转写部分已实现（r010，2026-09-20）**：说的内容秒级进文字对话、落库、并进纪要素材；**录制/旁路录音未做**（本行含录制，故整行仍未全绿） |
