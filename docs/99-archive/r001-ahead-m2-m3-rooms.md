...
| R-2 | 用邀请的落点 | ① 直接成为成员 ② 仍走等候室申请 | ②（与交付要求「进入房间前需经过等候室」一致） | 影响 M2 流程 |
...
- **流程**：点「通过邀请加入」→ 仍进入等候室（提交申请，标注「凭邀请」）→ 房主批准后进入正式讨论。理由：交付要求要求「进入房间前需经过等候室：房主批准后才能进入正式讨论」，邀请只降低找房间成本，不绕过审批。
