...
# r008（作业必做补全）：纪要 / 邀请 / 转写
ERR_SUMMARY_FAILED = "SUMMARY_FAILED"
ERR_LLM_NOT_CONFIGURED = "LLM_NOT_CONFIGURED"
ERR_INVITE_INVALID = "INVITE_INVALID"
ERR_SELF_APPROVAL = "SELF_APPROVAL"
"""r009：协管的焦点申请不能由本人批准（ADR-0021 D2）。"""
# r012（全服大屏聊天）：每人窗口内发言条数上限
ERR_RATE_LIMITED = "RATE_LIMITED"
ERR_STT_FAILED = "STT_FAILED"
ERR_STT_NOT_CONFIGURED = "STT_NOT_CONFIGURED"
