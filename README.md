...
| `docs/00-project/global-delivery.md` | **交付说明**：正文 = 作业题目 A 交付物四项（源代码或 Git 仓库链接 · 设计说明+README+环境变量示例 · 测试或冒烟脚本运行说明 · AI 工具与模型列表），附录 = 评审复核路径、提交口径 |
...
- **交付物**：zip + Git 仓库链接（`https://github.com/YeTor53/learning-guide`）+ npm 包（发布细则待定）；**交付说明与提交口径见 `docs/00-project/global-delivery.md`**
